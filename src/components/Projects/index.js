                  ...
                  <section id="work" className="page-section text-center">
                    <div className="container-fluid">
                      <div className="row projects">
                        ...
                        {projects.map(project => <ProjectCard title={project.title} description={project.description} appLink={project.appLink} githubRepoLink={project.githubRepoLink} imageURL={project.image} />)}
                      </div>
                    </div>
                  </section>
                </div>
